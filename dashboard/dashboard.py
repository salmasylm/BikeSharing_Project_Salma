...
width  = 0.35
bars1  = ax.bar(x - width/2, casual_register_df["total_casual"],     width, label="Tidak Resmi",     color="#FF6347")
bars2  = ax.bar(x + width/2, casual_register_df["total_registered"], width, label="Resmi", color="#4682B4")
ax.set_xticks(x)
