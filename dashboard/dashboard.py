...
st.info("""
Bisnis penyewaan sepeda mengalami pertumbuhan pesat dengan volume penyewaan pada tahun kedua
yang jauh melampaui tahun pertama di semua kategori waktu. Pola penggunaan didominasi oleh
aktivitas komuter pada hari kerja dengan puncak kepadatan di jam berangkat (08.00) dan pulang
kantor (17.00–18.00). Selain faktor rutinitas kerja, minat penyewaan juga sangat dipengaruhi
oleh faktor musim dan cuaca — permintaan mencapai titik tertinggi pada periode musim hangat
